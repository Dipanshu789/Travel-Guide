...
const GenerateButton = ({ onPress, disabled, loading }: GenerateButtonProps) => {
  return (
    <StyledWrapper style={{ opacity: disabled ? 0.6 : 1, pointerEvents: disabled ? 'none' : 'auto' }}>
      <div className="btn-wrapper" onClick={onPress}>
...
const StyledWrapper = styled.div`
  ...
  .btn:focus .txt-1, .btn:active .txt-1 {
    animation: opacity-anim 0.3s ease-in-out forwards;
    animation-delay: 1s;
  }
  .btn:focus .txt-2, .btn:active .txt-2 {
  ...
  .btn:focus .btn-letter, .btn:active .btn-letter {
    animation:
  ...
  .btn:focus .btn-svg, .btn:active .btn-svg {
